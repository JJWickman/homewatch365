...
const TEMPLATES = [
  ...
  },
  {
    ...
    items: [
      ...
      { section: 3, label: 'Bathrooms: Always careful and mindful of splashing water on glass enclosures', sort_order: 10, response_type: 'instruction_only', required: false },
      { section: 3, label: 'Run water in showers and tubs, checking for visible leaks', sort_order: 11, response_type: 'ok_issue_na', required: true, allow_na: true, allow_note: true, allow_photo: true, allow_severity: true },
      { section: 3, label: 'Always mindful of the valve at the wall as well as any discoloration of the tile grout', sort_order: 12, response_type: 'instruction_only', required: false },
