...
import { CONDO_SECTIONS } from '@/components/checklist/checklistDefaults';

const STORAGE_KEY = 'draft_condo_villa_checklist';

export default function CondoVillaChecklistPage() {
  const [sections, setSections] = useState(CONDO_SECTIONS);
    ...
    const loadTemplate = async () => {
      try {
        ...
        if (members.length > 0) {
          ...
          const published = company?.settings?.checklists?.condo;
