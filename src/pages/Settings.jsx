      ...
      <Tabs defaultValue="profile">
        ...
        <TabsContent value="profile">
          ...
          <Card className="mt-6">
            <CardHeader>
              ...
              <CardDescription>
                Connect your Google Calendar or use a calendar subscription
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="border rounded-lg p-4">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">Two-way sync with your calendar</p>
                    </div>
                  </div>
                ...
                <p className="text-sm text-slate-600">
                  Connect your Google Calendar to automatically sync inspections and tasks. View your schedule in Google Calendar and get notifications on all your devices.
                </p>
              </div>

              {/* Calendar Subscription (iCal/Webcal) */}
              <div>
        ...
        <TabsContent value="financial">
         ...
         <TabsContent value="reviews" className="space-y-6">
          <ReviewsTab companyForm={companyForm} />
        </TabsContent>
